...
int main(int argc, char ** argv)
{
  ...
  std::vector<double> center = {0.4, 0.0, 1.5};
  ...
  p1.pose.position.x = center[0];
  p1.pose.position.y = center[1] + 0.2;
  p1.pose.position.z = center[2];
  p1.pose.orientation.w = 0.7071;
  p1.pose.orientation.y = -0.7071;
  p2.header.frame_id = "world";
  p2.pose.position.x = center[0];
  p2.pose.position.y = center[1] - 0.2;
  p2.pose.position.z = center[2];
  p2.pose.orientation.w = 0.7071;
  p2.pose.orientation.y = -0.7071;
  p3.header.frame_id = "world";
  p3.pose.position.x = center[0];
  p3.pose.position.y = center[1];
  p3.pose.position.z = center[2];
  p3.pose.orientation.w = 0.7071;
  p3.pose.orientation.y = -0.7071;
  geometry_msgs::msg::Pose ref1, ref2, ref3, ref4, ref5, ref6;
  ref1.position.x = center[0];
  ref1.position.y = center[1];
  ref1.position.z = center[2] - 0.2;
  ref1.orientation.w = 0.7071;
  ref1.orientation.y = -0.7071;
  ref2.position.x = center[0];
  ref2.position.y = center[1];
  ref2.position.z = center[2] + 0.2;
  ref2.orientation.w = 0.7071;
  ref2.orientation.y = -0.7071;
  ref3.position.x = center[0];
  ref3.position.y = center[1] + 0.1;
  ref3.position.z = center[2] - 0.1;
  ref3.orientation.w = 0.7071;
  ref3.orientation.y = -0.7071;
  ref4.position.x = center[0];
  ref4.position.y = center[1] - 0.1;
  ref4.position.z = center[2] + 0.1;
  ref4.orientation.w = 0.7071;
  ref4.orientation.y = -0.7071;
  ref5.position.x = center[0];
  ref5.position.y = center[1] - 0.1;
  ref5.position.z = center[2] - 0.1;
  ref5.orientation.w = 0.7071;
  ref5.orientation.y = -0.7071;
  ref6.position.x = center[0];
  ref6.position.y = center[1] + 0.1;
  ref6.position.z = center[2] + 0.1;
